$(document).ready(function() {
	...
	$('input[type=submit]').click(function(evnt) {
        ...
        if ( $('input[type=radio]:checked').length <= 7) {//if an input inside each question is not checked
            alert("Something's not working! Make sure you've answered all the questions!");
        } else if (answers >= 8 && answers <= 13) {
